...
const templates: RawTemplate[] = [
  { title: 'ขอเบิกอุปกรณ์คอมพิวเตอร์ใหม่ — Notebook สำหรับงานออกแบบ', dept: 'it',    pri: 'high',   status: 'in_progress',     due: d(2026,5,16), created: d(2026,5,8),  requester: 'u01', assignee: 'u05', approver: 'u09', progress: 40, attachments: [{ name:'รายละเอียดประกอบ.pdf', size:'248 KB' },{ name:'ใบเสนอราคา_v2.xlsx', size:'62 KB' }] } as unknown as RawTemplate,
  { title: 'ขออนุมัติเดินทางไปประชุมที่จังหวัดเชียงใหม่ 14–16 พ.ค.',  dept: 'fin',   pri: 'normal', status: 'waiting_approval', due: d(2026,5,13), created: d(2026,5,7),  requester: 'u02', assignee: 'u07', approver: 'u10', progress: 95, attachments: [{ name:'เอกสารแนบ.pdf', size:'1.2 MB' }] } as unknown as RawTemplate,
  { title: 'ขอเบิกค่าเลี้ยงรับรองลูกค้าโครงการ Aurora',                dept: 'fin',   pri: 'normal', status: 'completed',        due: d(2026,5,8),  created: d(2026,5,6),  requester: 'u03', assignee: 'u07', approver: 'u10', progress: 100, attachments: [] } as unknown as RawTemplate,
  { title: 'ขอลาพักร้อน 5 วัน ระหว่างวันที่ 20–24 พ.ค.',                dept: 'hr',    pri: 'low',    status: 'completed',        due: d(2026,5,9),  created: d(2026,5,5),  requester: 'u04', assignee: 'u06', approver: 'u11', progress: 100, attachments: [] } as unknown as RawTemplate,
  { title: 'ขอแก้ไขสิทธิ์เข้าระบบ ERP สำหรับทีมจัดซื้อ',                dept: 'it',    pri: 'urgent', status: 'open',             due: d(2026,5,11), created: d(2026,5,9),  requester: 'u01', assignee: null as unknown as string, approver: 'u09', progress: 0, attachments: [] } as unknown as RawTemplate,
  { title: 'ขอเสนอจัดซื้อโปรเจกเตอร์สำหรับห้องประชุม Sapphire',         dept: 'proc',  pri: 'normal', status: 'in_progress',      due: d(2026,5,15), created: d(2026,5,7),  requester: 'u02', assignee: 'u06', approver: 'u11', progress: 55, attachments: [{ name:'รายละเอียดประกอบ.pdf', size:'248 KB' },{ name:'ใบเสนอราคา_v2.xlsx', size:'62 KB' }] } as unknown as RawTemplate,
  { title: 'ขออนุมัติการจ้างพนักงานใหม่ ตำแหน่ง Senior Designer',       dept: 'hr',    pri: 'high',   status: 'waiting_approval', due: d(2026,5,14), created: d(2026,5,4),  requester: 'u03', assignee: 'u06', approver: 'u11', progress: 95, attachments: [{ name:'เอกสารแนบ.pdf', size:'1.2 MB' }] } as unknown as RawTemplate,
  { title: 'ขอติดตั้งซอฟต์แวร์ Adobe Creative Cloud (10 license)',     dept: 'it',    pri: 'normal', status: 'in_progress',      due: d(2026,5,18), created: d(2026,5,3),  requester: 'u04', assignee: 'u05', approver: 'u09', progress: 70, attachments: [] } as unknown as RawTemplate,
  { title: 'ขอใช้ห้องประชุมใหญ่ สำหรับงาน Townhall ประจำเดือน',         dept: 'admin', pri: 'normal', status: 'completed',        due: d(2026,5,7),  created: d(2026,5,2),  requester: 'u01', assignee: 'u08', approver: 'u09', progress: 100, attachments: [] } as unknown as RawTemplate,
  { title: 'ขอเบิกงบประมาณแคมเปญ Mid-Year Sale 2026',                  dept: 'mkt',   pri: 'high',   status: 'waiting_approval', due: d(2026,5,12), created: d(2026,5,6),  requester: 'u02', assignee: 'u06', approver: 'u11', progress: 95, attachments: [{ name:'รายละเอียดประกอบ.pdf', size:'248 KB' },{ name:'ใบเสนอราคา_v2.xlsx', size:'62 KB' }] } as unknown as RawTemplate,
  { title: 'ขอเปลี่ยนแปลงเลขบัญชีพนักงาน',                              dept: 'hr',    pri: 'low',    status: 'open',             due: d(2026,5,17), created: d(2026,5,9),  requester: 'u03', assignee: null as unknown as string, approver: 'u11', progress: 0, attachments: [] } as unknown as RawTemplate,
  { title: 'ขอจัดซื้อวัสดุสำนักงานประจำเดือน',                          dept: 'proc',  pri: 'low',    status: 'in_progress',      due: d(2026,5,19), created: d(2026,5,8),  requester: 'u04', assignee: 'u08', approver: 'u09', progress: 25, attachments: [] } as unknown as RawTemplate,
  { title: 'ขออนุมัติงบประมาณการอบรม Data Engineering ทีมงาน 8 คน',     dept: 'hr',    pri: 'high',   status: 'waiting_approval', due: d(2026,5,15), created: d(2026,5,4),  requester: 'u01', assignee: 'u06', approver: 'u11', progress: 95, attachments: [{ name:'เอกสารแนบ.pdf', size:'1.2 MB' }] } as unknown as RawTemplate,
  { title: 'ขอเปลี่ยน Server Storage เนื่องจากใกล้เต็ม',                  dept: 'it',    pri: 'urgent', status: 'in_progress',      due: d(2026,5,10), created: d(2026,5,1),  requester: 'u02', assignee: 'u05', approver: 'u09', progress: 40, attachments: [] } as unknown as RawTemplate,
  { title: 'ขอออกใบกำกับภาษีให้กับลูกค้าบริษัท Northwind',              dept: 'fin',   pri: 'normal', status: 'completed',        due: d(2026,5,5),  created: d(2026,4,30), requester: 'u03', assignee: 'u07', approver: 'u10', progress: 100, attachments: [] } as unknown as RawTemplate,
